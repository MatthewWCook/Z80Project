...
UART0:       .EQU   UARTBASE + $00		;Data in/out
UART1:       .EQU   UARTBASE + $01      ;Check RX
UART2:       .EQU   UARTBASE + $02      ;Interrupts
UART3:       .EQU   UARTBASE + $03      ;Line control
UART4:       .EQU   UARTBASE + $04      ;Modem control
UART5:       .EQU   UARTBASE + $05      ;Line status
UART6:       .EQU   UARTBASE + $06      ;Modem status
UART7:       .EQU   UARTBASE + $07      ;Scratch register		
